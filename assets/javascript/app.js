$(document).ready(function() {
  ...
  function calcResults() {
    ...
    let filteredUserIncorrectAnsArr = userIncorrectAnsArr.filter(function(
      element
    ) {
      if (element != "") return element;
    });
    console.log(
      "Modified incorrect answer array: " + filteredUserIncorrectAnsArr
    );
    ...
    unansweredCounter =
      correctAnsArr.length - correctCounter - incorrectCounter;
